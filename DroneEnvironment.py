...
class DroneEnvironment():
    ...
    def step(self, action):
        ...
        for _ in range(1):
            ...
            # Calculating accelerations with Newton's laws of motions and finite difference approximation (Eulers method)
    ...
    def get_state(self):
        """
        Calculates the observation states
        Returns:
